...
struct animation resource_pet_end = { 2, resource_frames_pet_end, resource_durations_pet_end };
...
struct animation resource_pet = { 5, resource_frames_pet, resource_durations_pet };
...
struct animation resource_blink = { 4, resource_frames_blink, resource_durations_blink };
...
struct animation resource_pet_start = { 2, resource_frames_pet_start, resource_durations_pet_start };
...
struct animation resource_wake = { 20, resource_frames_wake, resource_durations_wake };
...
struct animation resource_mad = { 9, resource_frames_mad, resource_durations_mad };
...
struct animation resource_sleep = { 7, resource_frames_sleep, resource_durations_sleep };

int resource_frames_eat[1] = { RESOURCE_ID_FRAME_EAT_01 };
int resource_durations_eat[1] = { 2000 };
struct animation resource_eat = { 1, resource_frames_eat, resource_durations_eat };
