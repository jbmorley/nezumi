...
float sets_item_1_frames_item_0_duration = 0.25;
int sets_item_1_frames_item_0_resource = RESOURCE_ID_FRAME_SLEEP_01;
struct Frame sets_item_1_frames_item_0 = { 0.25, RESOURCE_ID_FRAME_SLEEP_01 };
float sets_item_1_frames_item_1_duration = 0.25;
int sets_item_1_frames_item_1_resource = RESOURCE_ID_FRAME_SLEEP_02;
struct Frame sets_item_1_frames_item_1 = { 0.25, RESOURCE_ID_FRAME_SLEEP_02 };
float sets_item_1_frames_item_2_duration = 0.25;
int sets_item_1_frames_item_2_resource = RESOURCE_ID_FRAME_SLEEP_03;
struct Frame sets_item_1_frames_item_2 = { 0.25, RESOURCE_ID_FRAME_SLEEP_03 };
float sets_item_1_frames_item_3_duration = 0.25;
int sets_item_1_frames_item_3_resource = RESOURCE_ID_FRAME_SLEEP_04;
struct Frame sets_item_1_frames_item_3 = { 0.25, RESOURCE_ID_FRAME_SLEEP_04 };
float sets_item_1_frames_item_4_duration = 0.25;
int sets_item_1_frames_item_4_resource = RESOURCE_ID_FRAME_SLEEP_05;
struct Frame sets_item_1_frames_item_4 = { 0.25, RESOURCE_ID_FRAME_SLEEP_05 };
float sets_item_1_frames_item_5_duration = 0.25;
int sets_item_1_frames_item_5_resource = RESOURCE_ID_FRAME_SLEEP_06;
struct Frame sets_item_1_frames_item_5 = { 0.25, RESOURCE_ID_FRAME_SLEEP_06 };
float sets_item_1_frames_item_6_duration = 0.25;
int sets_item_1_frames_item_6_resource = RESOURCE_ID_FRAME_SLEEP_07;
struct Frame sets_item_1_frames_item_6 = { 0.25, RESOURCE_ID_FRAME_SLEEP_07 };
